        ...
        <div className="min-h-screen bg-black text-white pt-32 pb-20 px-6 md:px-12">
            ...
            <div className="max-w-6xl mx-auto">
                <header className="mb-20 text-center">
                    <div className="reveal-up inline-block px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-semibold mb-6 tracking-widest text-orange-500 uppercase">
                        Join Our Team
                    </div>
                    <h1 className="reveal-up delay-100 text-4xl md:text-6xl font-bold mb-6">
                        Build the <span className="text-orange-500 underline decoration-white/20 underline-offset-8">Future</span> with Vorcas
                    </h1>
                    <p className="reveal-up delay-200 text-white/60 text-lg max-w-2xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                    {jobs.map((job, idx) => {
                        ...
                        return (
                            <div
                                key={job.id}
                                className="reveal-up p-8 rounded-3xl bg-white/[0.03] border border-white/5 hover:border-orange-500/50 transition-all group relative overflow-hidden"
